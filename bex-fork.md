...
Reconciled 2026-07-21 after the native sky-cua Codex plugin integration: **Managed native sky-cua Codex plugins** is a new runtime carry for fail-closed pre-thread installation, identity/hash/MCP verification, and release rollover. The current table now contains 46 active carry rows plus 3 absorbed-upstream records.
