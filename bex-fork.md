...
- SHA-256 checks for installed `dist/index.js` and `dist/hosts/codex/index.js` must match Heliasar commit `c66b4c5ec7ab0c937004a5f6f32ff6bb95dfddb8`.
