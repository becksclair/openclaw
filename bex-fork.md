...
| Private OpenClaw dependency publication                              | Support/proof carry   | High       | Saga resolves the `@openclaw` scope from private Gitea, so the workflow packs and publishes every OpenClaw-owned direct root dependency before publishing and deploying `openclaw`. Workspace runtimes get immutable per-run versions; fixed external versions require exact integrity; patched fs-safe also remains bundled for non-Gitea artifacts. Keep manifest discovery, root rewrite, tarball proof, and publication order aligned.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
