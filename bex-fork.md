...
| Managed native sky-cua Codex plugins                                 | Runtime carry         | Critical   | Stable has no consumer for the producer-owned `openai-bundled` marketplace. Carry the fixed-XDG pre-thread native installs for `computer-use` and `browser-use`, process-global per-client single-flight, Codex projection filtering for both plugin-owned MCP names, and the per-thread MCP-disable overlay. Treat the fixed producer root as trusted; deployment proof is one fresh native Computer/Browser turn, not hashes, cache inspection, or a release resolver.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
