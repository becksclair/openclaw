...
/** Hidden request for the trusted final TTS audio generated by a completed chat run. */
export const ChatFinalAudioGetParamsSchema = Type.Object(
  {
...
const ChatFinalAudioOutputFormatSchema = Type.Union([
  Type.Literal("opus"),
  Type.Literal("ogg"),
  Type.Literal("mp3"),
  Type.Literal("wav"),
...
/** Maximum final-audio payload size returned as base64 by chat.finalAudio.get. */
export const CHAT_FINAL_AUDIO_BASE64_MAX_LENGTH = 512 * 1024;

/** Playback-only final-audio lookup result; misses are fallback signals. */
export const ChatFinalAudioGetResultSchema = Type.Union([
  Type.Object(
    {
      found: Type.Literal(true),
      audioBase64: Type.String({ minLength: 1, maxLength: CHAT_FINAL_AUDIO_BASE64_MAX_LENGTH }),
      outputFormat: Type.Optional(ChatFinalAudioOutputFormatSchema),
      mimeType: Type.Optional(NonEmptyString),
      fileExtension: Type.Optional(NonEmptyString),
      spokenText: Type.Optional(NonEmptyString),
    },
    { additionalProperties: false },
  ),
  Type.Object(
...
export type ChatFinalAudioGetParams = Static<typeof ChatFinalAudioGetParamsSchema>;
export type ChatFinalAudioGetResult = Static<typeof ChatFinalAudioGetResultSchema>;
