...
/**
 * Assistant role and recognition-service helpers for the watch app.
 * Kept in sync with the phone copy at app/src/main/java/ai/openclaw/app/assistant/PhoneAssistantEntry.kt.
 */
